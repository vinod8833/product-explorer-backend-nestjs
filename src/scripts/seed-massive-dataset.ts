...
function getRandomPublisher(): string {
  return PUBLISHERS[Math.floor(Math.random() * PUBLISHERS.length)];
}

function getRandomPageCount(): number {
...
function generateImageUrl(title: string, isbn: string, sourceId: string): string {
