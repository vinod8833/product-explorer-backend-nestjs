...
async function checkRobotsCompliance() {
  ...
  const ethicalScraperService = app.get(EthicalScraperService);
  const worldOfBooksApiService = app.get(WorldOfBooksApiService);
